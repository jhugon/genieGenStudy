...
gevgen_hadron -n $N -p 321 -t 1000180400 -k $energy --run 117 \
    -f $pionFlux \
    --message-thresholds $messengerfile \
    -m "hA" \
    --seed 2989819 --cross-sections $xsfile >& logGen117

mv gntp.inuke.0.ghep.root kpAr.ghep.root

gevgen_hadron -n $N -p -321 -t 1000180400 -k $energy --run 118 \
    -f $pionFlux \
    --message-thresholds $messengerfile \
    -m "hA" \
    --seed 2989819 --cross-sections $xsfile >& logGen118

mv gntp.inuke.0.ghep.root kmAr.ghep.root

gevgen_hadron -n $N -p 2212 -t 1000180400 -k $energy --run 119 \
    -f $pionFlux \
    --message-thresholds $messengerfile \
    -m "hA" \
    --seed 2989819 --cross-sections $xsfile >& logGen119

mv gntp.inuke.0.ghep.root pAr.ghep.root
